...
## Description
Create the helicopter domain model. Define a status enum to track whether a helicopter is active or inactive. Build the JPA entity with registration details, operational limits, inspection tracking, and range information. Provide a Spring Data repository for persistence.
...
- [ ] `HelicopterRepository` extends `JpaRepository<Helicopter, Long>`
